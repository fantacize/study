// Randomized practice test pool — all items mixed across Chs 23-26 (1945-1989).
// Each test run pulls random subsets from this pool.
// Format per test: ~22 MCQ, 2 primary source analyses, 5 short answers, 60 min.
